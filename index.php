...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <div class="form-group col-sm-6">
        <input type="text" name="occupation" class="form-control" id="organization" placeholder="Enter Course Name Here...">
      </div>
      <div class="form-group col-sm-6">
        <input type="text" name="institution" class="form-control" id="institute" placeholder="Enter Institute Name Here...">
      </div>
      <div class="form-group col-sm-6">
        <input type="text" name="Serialop" class="form-control" id="Serialop" placeholder="Enter Serial Number Here...">
      </div>
    ...
    <?php 
      if (isset($_POST['generate'])) {
        ...
        $serial = (isset($_POST['Serialop']) ? $_POST['Serialop'] : '');
        if ($occupation || $institution || $serial) {
          $font_size_occupation = 10;
          $font_size_institution = 10;
          $font_size_serial = 10;
        }

        if ($name == "" || $occupation == "" || $institution == "" || $serial=="") {
          echo 
          "
          ...
          //echo $font_size;
          $text3 = imagettftext($createimage, $font_size_institution, $rotation, $origin2_x, $origin2_y, $black, $drFont1, $institution);
          imagepng($createimage,$output,3);
          $text4 = imagettftext($createimage, $font_size_institution, $rotation, $origin2_x+350, $origin2_y, $black, $drFont1, $serial);
          imagepng($createimage,$output,3);
...
<?php 
     ...
     ?>
      ...
      <footer>  
          <center><p>Built with &#10084; by <a href="https://adityamathur25.github.io/Portfolio/">Aditya Mathur</a></p></center>
      </footer>
